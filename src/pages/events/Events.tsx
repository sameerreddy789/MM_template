...
const Text = cdn("/images/events/text.webp");
const dance = cdn("/images/events/dancef.webp");
const drama = cdn("/images/events/dramaf.webp");
const dramaMobile = cdn("/images/events/DramaMobilef.webp");
const music = cdn("/images/events/music1.webp");
const misc = cdn("/images/events/misc1.webp");
const photography = cdn("/images/events/proshow.webp");
const danceMobile = cdn("/images/events/DanceMobilef.webp");
const musicMobile = cdn("/images/events/MusicMobilef.webp");
const miscMobile = cdn("/images/events/MiscMobilef.webp");
const photographyMobile = cdn("/images/events/PhotographyMobilef.webp");
import Eventspage from "./components/Eventspage";
import { useRef, useState, useEffect } from "react";
import gsap from "gsap";
const TextMobile = cdn("/images/events/TextMobile.webp");
