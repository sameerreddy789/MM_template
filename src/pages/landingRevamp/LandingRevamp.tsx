...
const mobileMountains = cdn("/images/hero_hills.webp");
const tree = cdn("/images/landing/new_tree.webp");
const treeMob = cdn("/images/landing/new_tree.webp");
...
const mobileBackground = cdn("/images/hero_mobile.webp");
const mobileRegisterBtn = cdn("/svgs/landing/mobileRegisterBtn.svg");
const registerBtn = cdn("/svgs/landing/registerBtn.svg");
const wire = cdn("/svgs/landing/wire.svg");
const logo = cdn("/images/logo.webp");
const mobileCloud = cdn("/images/landing/cloud_1.webp");
