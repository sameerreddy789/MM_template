...
const dummyEventsData = [
  ...
  },
  {
    ...
    events: [
      { name: "The DJ Night", club_name: "Cultural Club", venue: "Main Stage", description: "High-energy EDM and DJ tracks to light up the night.", image_url: cdn("/images/events/Eventpics/dj_night.webp") },
