...
const door1 = cdn("/images/contact/Door1.webp");
const door2 = cdn("/images/contact/Door2.webp");
const door1mobile = cdn("/images/contact/Door1Mobile.webp");
const door2mobile = cdn("/images/contact/Door2Mobile.webp");
